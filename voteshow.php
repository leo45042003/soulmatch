...
$result = mysqli_query($link,"SELECT * FROM votes where id='1' && likes='1'&& response !=''"); //抓有回應的值 //顯示所有點YES的留言
...
$result = mysqli_query($link,"SELECT * FROM votes where id='1' && unlikes='1'&& response !=''"); //抓有回應的值 //顯示所有點NO的留言
while($record = mysqli_fetch_array($result))
{
